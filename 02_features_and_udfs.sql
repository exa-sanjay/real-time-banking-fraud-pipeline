-- ============================================================
--  EXASOL: FEATURE ENGINEERING + ML UDFs
--  Run after RAW tables are populated from Kafka
-- ============================================================
...
-- Run as scheduled SQL or external pipeline
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- STEP 2a: Compute fraud features  (velocity, deviation, flags)
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- STEP 3: SIMPLE ML DEMO
-- One fraud-scoring UDF + one batch scoring query
-- ─────────────────────────────────────────────

-- 3a. FRAUD SCORE UDF  (requires one demo fraud model in BucketFS)
